 ...
 * @description：
 */
public class PriceCityMappingEntity extends BaseEntity {
    ...
    private String priceCityScope = "STANDARD";
	...
	public PriceCityMappingEntity copy(){
		PriceCityMappingEntity pcme = new PriceCityMappingEntity();
		pcme.setActive(getActive());
		pcme.setAreaCode(getAreaCode());
		pcme.setAreaName(getAreaName());
		pcme.setArrivalPriceCityCode(getArrivalPriceCityCode());
		pcme.setArrivePriceCity(getArrivePriceCity());
		
		pcme.setCityCode(getCityCode());
		pcme.setCityName(getCityName());
		pcme.setCityType(getCityType());
		pcme.setCode(getCode());
		pcme.setCreateDate(getCreateDate());
		pcme.setCreateUser(getCreateUser());
		
		pcme.setErrorMsg(getErrorMsg());
		pcme.setId(getId());
		pcme.setIsLocations(getIsLocations());
		pcme.setModifyDate(getModifyDate());
		pcme.setModifyTime(getModifyTime());
		pcme.setModifyUser(getModifyUser());
		pcme.setModifyUserCode(getModifyUserCode());
		
		pcme.setNum(getNum());
		pcme.setOldSerial(getOldSerial());
		pcme.setPriceCityCode(getPriceCityCode());
		pcme.setPriceCityName(getPriceCityName());
		pcme.setPriceCityScope(getPriceCityScope());
		pcme.setProvinceCode(getProvinceCode());
		pcme.setProvinceName(getProvinceName());
		pcme.setRemarks(getRemarks());
		pcme.setResourceCode(getResourceCode());
		pcme.setStartPriceCity(getStartPriceCity());
		pcme.setStartPriceCityCode(getStartPriceCityCode());
		return pcme;
	}
