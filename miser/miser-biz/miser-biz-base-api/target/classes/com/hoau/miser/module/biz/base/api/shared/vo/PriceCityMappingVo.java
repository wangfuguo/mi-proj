 ...
 */
public class PriceCityMappingVo implements Serializable {
	 ...
	 *价格时效管理对象
	 */
	private PriceCityMappingEntity priceCityMappingEntity;
	...
	private List<PriceCityMappingEntity> priceCityList;
	/**备注*/
    private String bz;
	/**城市类型*/
	...
	public PriceCityMappingEntity getPriceCityMappingEntity() {
		return priceCityMappingEntity;
	}

	public void setPriceCityMappingEntity(PriceCityMappingEntity priceCityMappingEntity) {
		this.priceCityMappingEntity = priceCityMappingEntity;
	}

	public List<PriceCityMappingEntity> getPriceCityList() {
		return priceCityList;
	}

	public void setPriceCityList(List<PriceCityMappingEntity> priceCityList) {
