 ...
 * @version V1.0
 */
public class PrivilegeCouponInfo implements Serializable {
	private static final long serialVersionUID = -6772636564807670699L;
	
	private String  customerCode;
	private PrivilegeCouponAcceptorInfo acceptor;
	 ...
	 * @return the acceptor
	 */
	public PrivilegeCouponAcceptorInfo getAcceptor() {
		return acceptor;
	}
	/**
	 * @param acceptor the acceptor to set
	 */
	public void setAcceptor(PrivilegeCouponAcceptorInfo acceptor) {
