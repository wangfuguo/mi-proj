...
<%
	...
	String ssoLoginUrl = props.getProperty("sso.login.url");
%>
...
<script type="text/javascript">
    ...
    var userToPmsByCasErrCode = '<%=request.getAttribute("userToPmsByCasErrCode")%>';
    var loginType = '<%=request.getAttribute("loginType")%>';
    
    if(loginType == 'sso'){ //sso 登录时
        if( userToPmsByCasErrCode != 'success' ){
