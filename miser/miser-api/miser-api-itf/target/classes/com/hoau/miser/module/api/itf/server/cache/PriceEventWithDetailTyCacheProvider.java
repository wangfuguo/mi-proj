...
/**
 * @description 运输类型缓存
 * ClassName: PriceEventWithDetailTyCacheProvider
 * @author yulin.chen@newhoau.com.cn
 * @date 2015年12月26日
 * @version V1.0
 */
@Component
public class PriceEventWithDetailTyCacheProvider implements ITTLCacheProvider<List<PriceEventEntity>> {
	...
	public List<PriceEventEntity> get(String param) {
		...
		queryEntity.setOrderChannel(keys.get(0));
		...
		queryEntity.setTransportType(keys.get(6));
		return priceEventTyDao.queryEventsWithDetail(queryEntity);
	}
