...
import com.hoau.miser.module.api.itf.api.server.IPriceDeliveryFeeCityTypeTyService;
...
import com.hoau.miser.module.api.itf.server.cache.PriceDeliveryFeeCityTypeTyCache;
 ...
 */
@Service
public class PriceDeliveryFeeCityTypeTyService implements IPriceDeliveryFeeCityTypeTyService {
	...
	public List<PriceDeliveryFeeCityTypeEntity> queryListByParam(
		...
		if (!priceDeliveryFeeCityType.isHistory()) {
			...
			ICache<String, List<PriceDeliveryFeeCityTypeEntity>> cache = CacheManager
					.getInstance().getCache(PriceDeliveryFeeCityTypeTyCache.UUID);
