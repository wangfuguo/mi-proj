...
public class CityTypeEntity extends BaseEntity {
	...
	public String toString() {
		return "CityTypeEntity [provinceCode=" + provinceCode
				+ ", provinceName=" + provinceName + ", cityCode=" + cityCode
				+ ", cityName=" + cityName + ", areaCode=" + areaCode
				+ ", areaName=" + areaName + ", cityType=" + cityType
				+ ", remark=" + remark + ", createTime=" + createTime
				+ ", createUserCode=" + createUserCode + ", modifyTime="
